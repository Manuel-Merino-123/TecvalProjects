...
def update_plot():
    ...
    Circle_Outside2=plt.Circle((0,0),Outside_diameter2/2,color='gold',fill=False,ls='-',linewidth=0.5)
    Circle_Bolt2 = plt.Circle((0, 0), Diameter_bolt_Circle2/2, color='lime', fill=False, ls='-.', linewidth=0.5)
    ...
    axis_lim = np.maximum(0,Outside_diameter2)
...
Outside_diameter2_entry.insert(0, "2")  # Valor por defecto
...
Diameter_bolt_Circle2_entry.insert(0, "1.2")  # Valor por defecto
...
diameter_bolt_hole2_entry.insert(0, "0.1")  # Valor por defecto
...
num_Circles2_entry.insert(0, "5")  # Valor por defecto
